...
class StateMachine {
   ...
   * @property {string[]|string} roles - The roles allowed to perform the transition. Use '*' (string or in array) to allow any role.
   * @property {Function} [guard] - Optional guard function that receives a context object and returns a boolean indicating if the transition is allowed.
   *
   */
