  ...
  apps: [
    {
      name: "celery_worker",
      script: "python",
      args: "-m celery -A workers.celery_app worker --loglevel INFO -O fair --pidfile celery_worker.pid --hostname 'hdw-celery-w1@%h' --autoscale=16,2 --queues 'hdw.sca.iu.edu.q'",
      watch: false,
      interpreter: "",
