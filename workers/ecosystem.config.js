  ...
  apps: [
    {
      name: "celery_worker",
      script: "python",
      args: "-m celery -A workers.celery_app worker --loglevel INFO -O fair --pidfile celery_worker.pid --hostname 'biobank-celery-w1@%h' --autoscale=16,2 --queues 'biobank.sca.iu.edu.q'",
      watch: false,
      interpreter: "",
