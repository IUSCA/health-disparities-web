...
<template>
  <div class="w-full flex flex-row">
    <div class="w-4/6  mb-2 mr-4 flex flex-col">
      <div class="flex">
        <va-input v-model="options.search"  class=" w-full mb-6 rounded" label="Search"  clearable> 
            <template #prependInner> <Icon icon="material-symbols:search" class="text-xl" /> </template> 
          </va-input>
      </div>

      <va-data-table style=" height: calc(100vh - 20rem)" :items="participants" :columns="columns" v-model:sort-by="options.sortBy" v-model:sorting-order="options.sortingOrder" virtual-scroller sticky-header>
      ...
      <div class="mt-2 flex flex-row content-end">
        <va-select class="w-2  w-full  rounded" v-model="options.numPerPage"
    ...
    <div class="w-1/6">
      ...
      <div class="flex">
        <va-select class="w-2 w-full  rounded" v-model="category"
          ...
          <div v-if="include.edit" class="border-gray-500 border border-solid p-4">
            ...
            <div v-if="include.category" class="mb-2">
              ...
              <va-input v-if="include.field in include.operators && include.operators[include.field].length > 1"
                class="w-2  w-full rounded" v-model="include.val" label="Value" />
