...
const saveCohort = async () => {
  ...
  console.log(cohort_name.value.text, includes.value, excludes.value, resultsByDetails.value[resultsBy.value])
...
<div class="flex flex-col">
    ...
    <div class="flex flex-row mb-4">
      ...
      <va-select  class="w-2 border-gray-500 border border-solid w-full rounded" v-model="cohort_name" label="Cohort" :options="cohort_options"  searchable highlight-matched-text allow-create="unique" @create-new="addNewOption" />
    </div>
